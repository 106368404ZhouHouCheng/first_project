...
# sitting_data.to_csv("20200203whole_sitting.csv" , encoding = "utf-8")
...
# lying_data.to_csv("20200203whole_lying.csv" , encoding = "utf-8")


sitting_data = pd.read_csv('20200203whole_sitting.csv')
lying_data = pd.read_csv('20200203whole_lying.csv')

whole_train_data = sitting_data.append(lying_data, ignore_index=True)

# print(whole_train_data)

whole_train_data.to_csv("20200203whole_train_data.csv" , encoding = "utf-8")
